package com.locdevz.nhamaynuoc.backend.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${locdevz.app.jwtSecret}")
    private String jwtSecret;
    @Value("${locdevz.app.jwtExpirationMs}")
    private int jwtExpirationMs;
    @Value("${locdevz.app.jwtCookieName}")
    private String jwtCookie;
    @Value("${locdevz.app.jwtRefreshCookieName}")
